...
export default function AddPracticePage() {
  ...
  return (
    <div className={styles.container}>
      <Text size={700} weight="bold">Add New Practice</Text>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <Field label="Specialization">
              <Dropdown
                ...
                onOptionSelect={(_, data) => handleInputChange("specialization", data.optionValue as string)}
              >
            ...
            <Text size={500} weight="semibold">Location</Text>
            ...
            <div className={styles.formRow}>
              <Field label="Postal Code" className={styles.formField}>
                <Input
                  ...
                  onChange={(_, data) => handleInputChange("postalCode", data.value)}
            ...
            <Field label="Owner Name" required>
              <Input
                ...
                onChange={(_, data) => handleInputChange("ownerName", data.value)}
            ...
            <Field label="Estimated Value">
              <Input
                ...
                onChange={(_, data) => handleInputChange("estimatedValue", data.value)}
