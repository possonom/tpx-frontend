...
export default function AddPharmacyPage() {
  ...
  return (
    <div className={styles.container}>
      <Text size={700} weight="bold">Add New Pharmacy</Text>
          ...
          <form onSubmit={handleSubmit} className={styles.form}>
            ...
            <Field label="Pharmacy Type">
              <Dropdown
                ...
                onOptionSelect={(_, data) => handleInputChange("type", data.optionValue as string)}
              >
            ...
            <Field label="Annual Revenue">
              <Input
                ...
                onChange={(_, data) => handleInputChange("annualRevenue", data.value)}
